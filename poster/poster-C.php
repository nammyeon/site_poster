...
const defaultColors = {
    design1: '#a499ff', design2: '#ff99b6', design3: '#008cbd', design4: '#ff7062', design5: '#4cbf64'
};
...
function resetPoster() {
    ...
    form.name.value = '동물의약품';
    form.hours.value = '심장사상충약, 종합구충제, 동물의약품\n약국에서 상담받고 구매하세요.';
    form.contact.value = '취급,판매허가약국';
    ...
    <div class="container">
        ...
        <section class="info-input">
            ...
            <form id="pharmacyForm" method="post" action="poster_save.php">
                ...
                <input type="hidden" name="nameColor" id="hiddenNameColor" value="#a499ff">
                <input type="hidden" name="hoursColor" id="hiddenHoursColor" value="#000000">
                <table>
                    <tr>
                        <td><label for="name">샘플문구(A):</label></td>
                        <td><input type="text" id="name" name="name" oninput="updatePoster()" required maxlength="5" value="동물의약품" placeholder="최대 5글자"></td>
                    </tr>
                    <tr>
                        <td><label for="hours">샘플문구(B):</label></td>
                        <td><textarea id="hours" name="hours" oninput="updatePoster()" required>심장사상충약, 종합구충제, 동물의약품
약국에서 상담받고 구매하세요。</textarea></td>
                    </tr>
                    <tr>
                        <td><label for="contact">샘플문구(C):</label></td>
                        <td><input type="text" id="contact" name="contact" oninput="updatePoster()" required maxlength="12" value="취급,판매허가약국" placeholder="최대 12글자"></td>
                    </tr>
                </table>
        ...
        <div class="monitor-frame">
            <div id="posterContainer" class="poster">
                <div id="posterText">
                    ...
                    <p id="posterHours">심장사상충약, 종합구충제, 동물의약품
약국에서 상담받고 구매하세요。</p>
