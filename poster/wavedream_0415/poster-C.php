...
function getDefaultTextColor(design) {
    switch(design) {
        case 'design1': return '#a499ff';
        case 'design2': return '#ff99b6';
        case 'design3': return '#008cbd';
        case 'design4': return '#ff7062';
        case 'design5': return '#4cbf64';
        default: return '#a499ff';
    }
}
...
function updatePoster() {
    ...
    let hoursFontSize = 16, contactFontSize = 28;
...
function resetPoster() {
    ...
    if (nameInput.value.trim() !== '') {
        nameInput.value = '동물의약품';
    }
    if (hoursInput.value.trim() !== '') {
        hoursInput.value = '심장사상충약, 종합구충제, 동물의약품\n약국에서 상담받고 구매하세요.';
    }
    if (contactInput.value.trim() !== '') {
        contactInput.value = '취급,판매허가약국';
    }
    if (nameColorInput.value !== '#a499ff') {
        nameColorInput.value = '#a499ff';
    }
...
window.onload = function() {
    ...
    document.getElementById('nameColor').value = '#a499ff';
            ...
            <form id="pharmacyForm" method="post" action="poster_save.php">
                ...
                <table>
                    <tr>
                        ...
                        <td><input type="text" id="name" name="name" oninput="updatePoster(); updateHiddenDesign();" required style="white-space: normal;" value="동물의약품" maxlength="5"></td>
                    </tr>
                    <tr>
                        <td><label></label></td>
                        <td class="name-style-group">
                            <label>(A)(B)컬러:</label>
                            <input type="color" id="nameColor" name="nameColor" value="#a499ff" oninput="updatePoster()">
                            <label>(C)컬러:</label>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="contact" name="contact" oninput="updatePoster(); updateHiddenDesign();" required placeholder="취급,판매허가약국" maxlength="12" value="취급,판매허가약국"></td>
                    </tr>
                    <tr>
                        <td><label for="hours">안내문구(C):</label></td>
                        <td><textarea id="hours" name="hours" oninput="updatePoster(); updateHiddenDesign();" required style="white-space: normal;">심장사상충약, 종합구충제, 동물의약품
약국에서 상담받고 구매하세요。</textarea></td>
                    </tr>
                </table>
    ...
    <section class="poster-preview">
        ...
        <div class="monitor-frame">
            <div id="posterContainer" class="poster">
                <div id="posterText">
                    <h2 id="posterName" style="text-align:right">동물의약품</h2>
                    <p id="posterHours">약국에서 상담받고 구매하세요。</p>
                    <p id="posterContact">취급,판매허가약국</p>
                </div>
            </div>
        </div>
    </section>
