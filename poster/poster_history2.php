                ...
                <tbody>
                    ...
                    while ($row = sql_fetch_array($result)) {
                        ...
                        if ($design_type == 'I') {
                            ...
                            $guide_a .= '<div class="content-group"><div class="group-title">상단 제목:</div><div class="content-item">' . nl2br($topTitle) . '</div></div>';
                            $guide_a .= '<div class="content-group"><div class="group-title">메인 제목:</div><div class="content-item">' . nl2br($mainTitle) . '</div></div>';
                            $guide_a .= '<div class="content-group"><div class="group-title">가격:</div><div class="content-item">' . nl2br($price) . '</div></div>';
                            $guide_a .= '<div class="content-group"><div class="group-title">가격 상세:</div><div class="content-item">' . nl2br($priceDetail) . '</div></div>';
                            $guide_a .= '</div>';
                            
                            // 안내문구 B: 혜택 정보
                            $guide_b = '<div class="type-i-content">';
                            if ($benefit1) $guide_b .= '<div class="content-group"><div class="group-title">혜택1:</div><div class="content-item">' . nl2br($benefit1) . '</div></div>';
                            if ($benefit2) $guide_b .= '<div class="content-group"><div class="group-title">혜택2:</div><div class="content-item">' . nl2br($benefit2) . '</div></div>';
                            if ($benefit3) $guide_b .= '<div class="content-group"><div class="group-title">혜택3:</div><div class="content-item">' . nl2br($benefit3) . '</div></div>';
                            if ($benefit4) $guide_b .= '<div class="content-group"><div class="group-title">혜택4:</div><div class="content-item">' . nl2br($benefit4) . '</div></div>';
                            $guide_b .= '</div>';
                            
                            // 안내문구 C: 추천 문구 및 약국 정보
                            $guide_c = '<div class="type-i-content">';
                            if ($recommendText) $guide_c .= '<div class="content-group"><div class="group-title">추천 문구:</div><div class="content-item">' . nl2br($recommendText) . '</div></div>';
                            if ($pharmacy) $guide_c .= '<div class="content-group"><div class="group-title">약국명:</div><div class="content-item">' . nl2br($pharmacy) . '</div></div>';
                            $guide_c .= '</div>';
