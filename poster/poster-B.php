...
const defaultColors = {
    design1: '#00BA88', design2: '#3068d0', design3: '#ffc132', design4: '#d633fe', design5: '#f33e31'
};
...
function updatePoster() {
    ...
    const hoursColor = defaultColors[selectedDesign];
    ...
    poster.contact.style.color = defaultColors[selectedDesign];
    poster.name.style.fontSize = '30px';
    poster.hours.style.fontSize = '16px';
    poster.contact.style.fontSize = '40px';
...
function resetPoster() {
    ...
    form.name.value = '약사추천 필수영양제\n\n1. 종합비타민\n2. 마 그 네 슘\n3. 오 메 가  3\n4. 유   산   균';
    form.hours.value = 'OPEN 08:00 ~ CLOSE 20:00\n매달 2, 4번째 일요일 정기 휴무\nTEL : 000. 1234. 5678';
    ...
    <div class="container">
        ...
        <section class="info-input">
            ...
            <form id="pharmacyForm" method="post" action="poster_save.php">
                ...
                <input type="hidden" name="nameColor" id="hiddenNameColor" value="#000000">
                <input type="hidden" name="hoursColor" id="hiddenHoursColor" value="#00BA88">
                <table>
                    <tr>
                        <td><label for="name">샘플문구(A):</label></td>
                        <td><textarea id="name" name="name" oninput="updatePoster()" required>약사추천 필수영양제
...
4. 유   산   균</textarea></td>
                    ...
                    <tr>
                        ...
                        <td><textarea id="hours" name="hours" oninput="updatePoster()" required>OPEN 08:00 ~ CLOSE 20:00
매달 2, 4번째 일요일 정기 휴무
    ...
    <section class="poster-preview">
        ...
        <div class="monitor-frame">
            <div id="posterContainer" class="poster">
                <div id="posterText">
                    <h2 id="posterName">약사추천 필수영양제

1. 종합비타민
2. 마 그 네 슘
3. 오 메 가  3
4. 유   산   균</h2>
                    <p id="posterHours">OPEN 08:00 ~ CLOSE 20:00
매달 2, 4번째 일요일 정기 휴무
TEL : 000. 1234. 5678</p>
