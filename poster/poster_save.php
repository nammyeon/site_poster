...
$row_contact = isset($_POST['contact']) ? trim(clean_xss_tags($_POST['contact'])) : '';
$contact = get_text(htmlspecialchars($row_contact, ENT_QUOTES)); // HTML 특수문자 처리 및 텍스트 정제
$extra = isset($_POST['extra']) ? trim(clean_xss_tags($_POST['extra'])) : '';
...
$wr_subject = $name . " / Type: " . $design_type . " / Num: " . $design;
$content_summary = "design_type: " . $design_type . " / design: " . $design . " / name: " . $name . " / hours: " . $hours . " / contact: " . $contact . " / extra: " . $extra . " / name_color: " . $name_color . " / hours_color: " . $hours_color;
...
$sql = "INSERT INTO wd_write_poster_save 
        SET wr_num = (SELECT IFNULL(MIN(wr_num) - 1, -1) FROM wd_write_poster_save as sq),
            ...
            wr_8 = '" . sql_real_escape_string($extra) . "',
            wr_9 = '',
            wr_10 = ''";
